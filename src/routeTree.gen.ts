...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/about' | '/channels' | '/live' | '/search' | '/settings' | '/watch' | '/category/$genre' | '/channel/$channelId'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/about' | '/channels' | '/live' | '/search' | '/settings' | '/watch' | '/category/$genre' | '/channel/$channelId'
  id: '__root__' | '/' | '/about' | '/channels' | '/live' | '/search' | '/settings' | '/watch' | '/category/$genre' | '/channel/$channelId'
